...
# 🎮 Orc Warchief: Prologue

**Tracking the work behind an orc strategy game.**
...
Orc Warchief: Prologue is a dark-fantasy strategy game combining village management, resource gathering, crafting, and real-time tactics. Players rebuild an orc settlement, train warriors, and organize a growing horde. This repository records pre-alpha development work and iteration.

This devlog may interest players and developers following strategy, city-building, and indie game development.
...
- 🏗️ **Village rebuilding** — Restore and expand settlements after the Great War.
- 🌲 **Resource management** — Gather materials, hunt for supplies, and support the tribe.
- ⚒️ **Crafting and preparation** — Craft weapons, build defenses, and prepare war machines.
- 🛡️ **Warrior training** — Train orc warriors and prepare them for conflict.
- 🚩 **Horde command** — Raise the warbanner and lead the orc horde.
- 🎯 **Limited prologue scope** — A focused selection of quests from the wider game concept.

## 📸 Screenshots

<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2003070/ss_373bc24dfeaa6ea4369d0489b905a4f6fdd84621.1920x1080.jpg?t=1757566983" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2003070/ss_2e21859f1eefb2ccd4bded52a5f9ff219e08f139.1920x1080.jpg?t=1757566983" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2003070/ss_c50d6bd8c518296e2717e6b4f1325b3d4fe23611.1920x1080.jpg?t=1757566983" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
